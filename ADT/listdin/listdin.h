...
#ifndef ListDinTree_H
#define ListDinTree_H
...
#define IDX_MIN_B 0
/* Indeks minimum list */
#define IDX_UNDEF_B -1
/* Indeks tak terdefinisi*/



/* Definisi elemen dan koleksi objek */
typedef struct nodet *ElDinType; /* type elemen list */

typedef struct ListDinTree
{
    ElDinType *buffer; /* memori tempat penyimpan elemen (container) */
...
/* ********** SELEKTOR ********** */
#define NEFFDINTREE(l) (l).nEff
#define BUFFERDINTREE(l) (l).buffer
#define ELMTDINTREE(l, i) (l).buffer[i]
#define CAPACITYDINTREE(l) (l).capacity
...
// ElDinType sumList(ListDinTree l);
